# Correction atelier 8.3 : Tests End To End de l'atelier 4.2

## Installation et lancement des tests

Pour lancer les tests fonctionnelles avec Cypress

1. Lancez le serveur de l'atelier 4.2 au préalable qui tourne normalement sur le PORT 4200, si ce n'est pas le cas pour vous, changer l'information au niveau de l'atelier 4.2 en mettant le port 4200 pour la variable d'environnement dédiée ou modifiez *cypress.config.js* en remplaçant le port 4200 par le port local de votre atelier 4.2.
...
### 1-ateliers/corrections/8.3

#### `1-ateliers/corrections/8.3/cypress.config.js`
...
describe("Testing Homepage workshop 4.2", () => {
  ...
  describe("Testing GET /", () => {
    ...
    it("Should have only one anchor link", () => {
      cy.visit("/"); // Arrange & Act
      cy.get("a").should("have.length", 1).and("contain.text", "Page de news"); // Assert
    });
  });
...
describe('Testing workshop 4.1 GET /news and GET /news/:id', () => {
    it('Should have list of news', () => {
        cy.visit('/news') // Arrange & Act
        cy.get('h1').should('exist').and('contain', 'International : Toute l’actualité sur Le Monde.fr.') // Assert
        cy.get('article').should('have.length', 20) // Assert
    })

     it('Should go to news/10 after click to details', () => {
        cy.visit('/news')
        cy.get('a[href="news/10"]').click()
        cy.get('h1').should('not.exist')
        cy.get('h2').should('contain.text', 'En Chine, des officiels')
        cy.get('a[href*="lemonde.fr/international"]').should('exist')
    })

    it('Should go to undefined id news/100 after click to details', () => {
        cy.visit('/news')
        cy.get('a[href="news/100"]').should('not.exist')
    })
})
```

#### `1-ateliers/corrections/8.3/cypress/e2e/1-getting-started/todo.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/actions.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/aliasing.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/assertions.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/connectors.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/cookies.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/cypress_api.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/files.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/location.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/misc.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/navigation.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/network_requests.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/querying.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/spies_stubs_clocks.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/storage.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/traversal.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/utilities.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/viewport.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/waiting.cy.js`
...
#### `1-ateliers/corrections/8.3/cypress/e2e/2-advanced-examples/window.cy.js`
...
#### `1-ateliers/corrections/8.3/package.json`
