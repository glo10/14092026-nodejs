...
### 1-ateliers/corrections/4.2

#### `1-ateliers/corrections/4.2/app.js`
...
#### `1-ateliers/corrections/4.2/controllers/news.js`
...
#### `1-ateliers/corrections/4.2/package.json`
...
```json
{
  ...
  "scripts": {
    "start": "node ./bin/www",
    "dev": "SET DEBUG=4.2:* & node --watch ./bin/www"
  },
  "dependencies": {
    "cookie-parser": "~1.4.7",
    "debug": "^4.4.3",
...
#### `1-ateliers/corrections/4.2/public/data/news.json`
...
#### `1-ateliers/corrections/4.2/public/stylesheets/style.css`
...
#### `1-ateliers/corrections/4.2/routes/index.js`
...
#### `1-ateliers/corrections/4.2/routes/news.js`
