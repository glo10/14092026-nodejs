...
- [Moteur de template Pug et son utilisation](https://pugjs.org/api/getting-started.html)
...
- Exécutez la commande `express --view=pug your_app_name` en remplacant *your_app_name* par le nom du dossier de votre choix par exemple "atelier_4.2"
